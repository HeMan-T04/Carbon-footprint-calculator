...
function person(x) {
    ...
    document.getElementById("ques").innerHTML = '<p class="display-6 text-center blockqoute" style="color:#242582" id="ques">Q2.What is the size of your home? :</p>';
    document.getElementById("options").innerHTML = '<div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="house(1);">a) You live in a large house.</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="house(2)">b) You live in a medium-sized house.</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="house(3)">c) You live in a small house.</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align : left;margin-left:1rem;" onclick="house(4)">d) You live in an apartment.</button></div>';
}
function house(x){
    if(x==1){
        carbon=carbon+10;
    ...
    document.getElementById("options").innerHTML = '<div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="food(1);">a) Domestic meat on a daily basis.</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="food(2)">b) Domestic meat a few times per week.</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="food(3)">c) You are a vegetarian.</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="food(4)">d) Vegan or only eat wild meat.</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="food(5)">e) Prepackaged convenience food mostly.</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="food(6)">f) You have good balance of fresh and convenience food.</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="food(7)">g) You eat fresh,locally grown only.</button></div>';
}
function food(x){
    if(x==1){
        carbon=carbon+10;
    ...
    document.getElementById("options").innerHTML = '<div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="water(1);">a) You run you washing machine more than 9 times per week.</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="water(2)">b) You run it 4 to 9 times per week .</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="water(3)">c) You run it 1 to 3 times per week.</button></div><div class="row container"><button class="btn btn-lg btn-outline rounded-5" style="color:#242582; text-align: left;margin-left:1rem;" onclick="water(4)">d) You do not have a washing machine and wash clothes by yourself.</button></div>';
}
function water(x){
    if(x==1){
        carbon=carbon+3;
    ...
    document.getElementById("ques").innerHTML = '<p class="display-6 text-center blockqoute" style="color:#242582" id="ques">Q5.How many household purchases do you make each year:</p>';
...
function purchase(x){
    ...
    document.getElementById("ques").innerHTML = '<p class="display-6 text-center blockqoute" style="color:#242582" id="ques">Q6.How much waste do you produce :</p>';
...
function garbage(x){
    ...
    document.getElementById("ques").innerHTML = '<p class="display-6 text-center blockqoute" style="color:#242582" id="ques">Q7.How much waste do you recycle :</p>';
